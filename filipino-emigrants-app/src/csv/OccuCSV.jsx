...
const OccuCSV = ({ collectionName = "occupation" }) => {
  ...
  const handleFileUpload = async (event) => {
    ...
    try {
      ...
      const storedHashes = JSON.parse(localStorage.getItem("uploadedOccuHashes") || "[]");
      ...
      Papa.parse(file, {
        ...
        complete: async (results) => {
          ...
          try {
            ...
            localStorage.setItem("uploadedOccuHashes", JSON.stringify(storedHashes));
